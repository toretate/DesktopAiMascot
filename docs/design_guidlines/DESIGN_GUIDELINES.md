...
| :--- | :--- | :--- | :--- |
| **プライマリ（通常）** | `rgba(51, 119, 245, 1.0)` | `#3377f5` | 保存・編集等の重要ボタンの背景、選択中マーク。 |
| **プライマリ（ホバー）** | `rgba(33, 97, 217, 1.0)` | `#2161d9` | プライマリボタンのホバー時の背景。 |
| **ナビ選択背景** | `rgba(217, 235, 250, 1.0)` | `#d9ebfa` | 左メニューで選択されたアイテムの背景色。 |
| **ナビホバー背景** | `rgba(235, 242, 250, 0.6)` | `#ebf2fa` (不透明度60%) | 左メニューのホバー時の背景色。 |
